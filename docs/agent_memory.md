...
- `Enable remote listener` sí controla el servidor HTTP real, pero su efecto se aplica al pulsar `Save and apply`; la UI debe dejarlo explícito para evitar ambigüedad.
